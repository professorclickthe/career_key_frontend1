    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative">
                ...
                <p className="text-sm text-gray-500 mb-6">Upload the file or scan the QR code on the degree to verify its authenticity.</p>
                <button
                    onClick={() => fileInput.current.click()}
                    className="w-full px-5 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition shadow"
                >
                    📁 Upload File / Scan QR
                </button>
                <input
